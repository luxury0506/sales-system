...
// HTK PVDF熱收縮套管（雲林電子，含型號對照，規格mm已直接標示於原始表格）
const HTK_TABLE = {
  "1.2": { model: "HTK-150-0012", cost: 12.99 },
  "1.6": { model: "HTK-150-0016", cost: 14.84 },
  "2.4": { model: "HTK-150-0024", cost: 18.81 },
  "3.2": { model: "HTK-150-0032", cost: 23.05 },
  "4.8": { model: "HTK-150-0048", cost: 31.54 },
  "6.4": { model: "HTK-150-0064", cost: 37.63 },
  "9.5": { model: "HTK-150-0095", cost: 55.39 },
  "12.7": { model: "HTK-150-0127", cost: 75.26 },
  "19.1": { model: "HTK-150-0191", cost: 130.11 },
  "25.4": { model: "HTK-150-0254", cost: 191.2 },
};

// ATM 通用型中壁含膠熱收縮套管（雲林電子，型號本身就含規格，如 ATM008BK = 8.0mm黑）
const ATM_TABLE = {
  "ATM008BK": { mm: 8.0, cost: 34 },
  "ATM012BK": { mm: 12.0, cost: 48 },
  "ATM016BK": { mm: 16.0, cost: 59 },
  "ATM019BK": { mm: 19.0, cost: 64 },
  "ATM022BK": { mm: 22.0, cost: 69 },
  "ATM028BK": { mm: 28.0, cost: 71 },
  "ATM033BK": { mm: 33.0, cost: 77 },
  "ATM040BK": { mm: 40.0, cost: 89 },
  "ATM044BK": { mm: 44.0, cost: 99 },
  "ATM055BK": { mm: 55.0, cost: 115 },
  "ATM065BK": { mm: 65.0, cost: 146 },
  "ATM075BK": { mm: 75.0, cost: 165 },
  "ATM085BK": { mm: 85.0, cost: 216 },
  "ATM095BK": { mm: 95.0, cost: 228 },
  "ATM115BK": { mm: 115.0, cost: 283 },
  "ATM140BK": { mm: 140.0, cost: 374 },
  "ATM160BK": { mm: 160.0, cost: 508 },
};
